...
export default abstract class Avatar implements AvatarInterface {
    ...
    constructor(ctx: CanvasRenderingContext2D, LARGURA: number) {
        this.x = 50;
        this.y = 0;
        this.color = "#ff4e4e";
        this.gravity = 1.5;
        this.avatar = {} as SprintInterface;
        this.width = this.avatar.width;
        this.height = this.avatar.heigth;
        this.powerJump = 22;
        this.rotation = 0;
        this.qtdJumps = 0;
        this.speed = 0;
        ...
        this.theme = 'farm';
        this.floor = {} as FloorInterface;
        this.obstacles = {} as ObstaclesInterface;
        this.bg = {} as SprintInterface;
    }
